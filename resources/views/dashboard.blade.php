                            ...
                            <div class="row">
                                @if($user->role === 'renter')
                                    <div class="col-md-3 mb-3">
                                        <a href="{{ route('payments.send') }}" class="btn btn-outline-primary w-100">
                                            <span class="me-2">💳</span>Make Payment
                                        </a>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <a href="{{ route('transactions.index') }}" class="btn btn-outline-success w-100">
                                            <span class="me-2">📋</span>Transaction Log
                                        </a>
                                    </div>
                                @elseif($user->role === 'owner')
                                    <div class="col-md-3 mb-3">
                                        <a href="{{ route('payments.index') }}" class="btn btn-outline-success w-100">
                                            <span class="me-2">📥</span>View Payments
                                        </a>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <a href="{{ route('transactions.index') }}" class="btn btn-outline-info w-100">
                                            <span class="me-2">📋</span>Transaction History
                                        </a>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <a href="#" class="btn btn-outline-warning w-100" onclick="showAlert('Property management coming soon!', 'info')">
                                            <span class="me-2">🏢</span>Manage Properties
                                        </a>
                                    </div>
                                @elseif($user->role === 'broker')
                                    <div class="col-md-3 mb-3">
                                        <a href="{{ route('chozi-codes.index') }}" class="btn btn-outline-warning w-100">
                                            <span class="me-2">🏷️</span>Manage Codes
                                        </a>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <a href="{{ route('chozi-codes.analytics') }}" class="btn btn-outline-success w-100">
                                            <span class="me-2">📈</span>Commission Report
                                        </a>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <a href="{{ route('payments.index') }}" class="btn btn-outline-info w-100">
                                ...
                                @else
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <a href="#" class="btn btn-outline-info w-100" onclick="showAlert('System settings coming soon!', 'info')">
